 ...
 return (
    <>
     <Routes>
       ...
       <Route path="/" element=
         {<Page_Grid>  <Landing_Page /> </Page_Grid>} />  {/*components.css  applied */}
       <Route path="/Login" element=
         {<Page_Grid>  <Login_Page />   </Page_Grid>} />  {/*components.css applied */}
       <Route path="/Games" element=
         {<Page_Grid>  <Games />   </Page_Grid>} /> {/*components.css  applied */}
       <Route path="/About" element=
         {<Page_Grid>  <About />  </Page_Grid>} />  {/*components.css not applied */}
       <Route path="/Creators_Page" element=
         {<Page_Grid>           <Creators_Page />            </Page_Grid>} />{/*components.css not fully applied looks like the form is part of the issue*/}
       <Route path="/Creators_SignUp" element=
         {<Page_Grid>         <Creators_SignUp />         </Page_Grid>} />{/*components.css not fully applied looks like the form is part of the issue*/}
       <Route path="/Profile_Page" element=
         {<Page_Grid>            <Profile_Page />            </Page_Grid>} /> {/*components.css not fully applied looks like the form is part of the issue*/}
       <Route path="/SignUp_Page" element=
         {<Page_Grid>             <SignUp_Page />             </Page_Grid>} />  {/*components.css not applied */}
       <Route path="/Guest_Page" element=
         {<Page_Grid>              <Guest_Page />               </Page_Grid>} />
       <Route path="/User_Page" element=
         {<Page_Grid>               <User_Page />               </Page_Grid>} /> 
       <Route path="/Moderator_Page" element=
         {<Page_Grid>          <Moderator_Page />           </Page_Grid>} />
       <Route path="/Admin_Page" element=
         {<Page_Grid>               <Admin_Page />               </Page_Grid>} />
       <Route path="/Master_Page" element=
         {<Page_Grid>              <Master_Page />              </Page_Grid>} />
       <Route path="/PGA2K" element=
         {<Page_Grid>                   <PGA2K />                    </Page_Grid>} /> {/*components.css works beautifully */}
       <Route path="/Search_Page_PGA2K23" element=
         {<Page_Grid>     <Search_Page_PGA2K23 />     </Page_Grid>} />
       <Route path="/Results_Page_PGA2K23" element=
         {<Page_Grid>    <Results_Page_PGA2K23 />     </Page_Grid>} /> 
       <Route path="/PGA2K23_C_Long" element=
         {<Page_Grid>          <PGA2K23_C_Long />           </Page_Grid>} />
       <Route path="/PGA2K23_R_Long" element=
         {<Page_Grid>          <PGA2K23_R_Long />           </Page_Grid>} />
       <Route path="/Search_Page_PGA2K25" element=
         {<Page_Grid>     <Search_Page_PGA2K25 />     </Page_Grid>} />
       <Route path="/Results_Page_PGA2K25" element=
         {<Page_Grid>    <Results_Page_PGA2K25 />     </Page_Grid>} /> 
       <Route path="/Course_Review" element=
         {<Page_Grid>           <Course_Review />            </Page_Grid>} />
       <Route path="/Suggestion_Box" element=
         {<Page_Grid>          <Suggestion_Box />          </Page_Grid>} />
       <Route path="/Help" element=
         {<Page_Grid>                    <Help />                     </Page_Grid>} />
       <Route path="/Legal" element=
         {<Page_Grid>                 <Legal />                    </Page_Grid>} />
       <Route path="/ReadMe" element=
         {<Page_Grid>                <ReadMe />                   </Page_Grid>} />
       <Route path="/Client_Front_Page" element=
         {<Page_Grid>        <Client_Front_Page />        </Page_Grid>} />
